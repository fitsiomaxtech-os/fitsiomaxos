...
# ─── Branch Admin Pipeline Endpoints ───
...
@v3_router.get("/branch-board/{branch_id}")
...
@v3_router.post("/leads/{lead_id}/branch-stage")
...
@v3_router.post("/leads/{lead_id}/collect-fee")
...
@v3_router.post("/leads/{lead_id}/assign-physio")
